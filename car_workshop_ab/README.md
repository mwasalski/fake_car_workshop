...
The 'car_workshop_ab' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/car_workshop_ab/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] car_workshop_ab_etl` to your workspace.
